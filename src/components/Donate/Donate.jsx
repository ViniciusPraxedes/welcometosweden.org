            ...
            <div className="donate">
                <div className="donate-wrapper">
                    <div className="creator">
                        ...
                        <p>This project was entirely created by Vinicius Praxedes with the objective of helping expats who wants to live in Sweden</p>
                    ...
                    <div className="swish">
                        ...
                        <p>Your contribution makes a huge difference in
                            keeping the project going.
                            Every donation, no matter how small, helps me continue
                            the work and cover the hosting costs.</p>
                        <h1>Swish</h1>
